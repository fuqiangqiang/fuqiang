	...
	mui.init({
		beforeback: function() {
			if(flag) {
				...
				mui.fire(plus.webview.getWebviewById('device-add.html'), 'getCameraType', cameraType);
				mui.fire(plus.webview.getWebviewById('device-detail.html'), 'getCameraType', cameraType);
			}
		}
	});
	initEvents();
...
mui.plusReady(function() {
	...
	$("#sxjul").html("");
	var plist = "";
    $.each(self.gndata, function(idx,val) {
